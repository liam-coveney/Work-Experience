...
class catanBoard(hexTile, Vertex):
    ...
    def __init__(self):
        ...
        self.size = self.width, self.height = 1420, 800
        self.flat = hexLib.Layout(hexLib.layout_flat, hexLib.Point(self.edgeLength, self.edgeLength), hexLib.Point((self.width - 280)/2, self.height/2)) #specify Layout
    ...
    def getHexCoords(self, hexInd):
        ...
        coordDict = {0:hexLib.Axial_Point(0,0), 1:hexLib.Axial_Point(0,-1), 2:hexLib.Axial_Point(1,-1), 3:hexLib.Axial_Point(1,0), 4:hexLib.Axial_Point(0,1), 5:hexLib.Axial_Point(-1,1), 6:hexLib.Axial_Point(-1,0), 7:hexLib.Axial_Point(0,-2), 8:hexLib.Axial_Point(1,-2), 9:hexLib.Axial_Point(2,-2), 10:hexLib.Axial_Point(2,-1),
                        11:hexLib.Axial_Point(2,0), 12:hexLib.Axial_Point(1,1), 13:hexLib.Axial_Point(0,2), 14:hexLib.Axial_Point(-1,2), 15:hexLib.Axial_Point(-2,2), 16:hexLib.Axial_Point(-2,1), 17:hexLib.Axial_Point(-2,0), 18:hexLib.Axial_Point(-1,-1)}
    ...
    def generateVertexGraph(self):
        for hexTile in self.hexTileDict.values():
            hexTileCorners = hexLib.polygon_corners(self.flat, hexTile.hex) #Get vertices of each hex
    ...
    def updatePorts(self):
        ...
        port_dict = {'BRICK 2:1':1, 'SHEEP 2:1':1, 'WOOD 2:1':1, 'WHEAT 2:1':1, 'ORE 2:1':1, '3:1 PORT':4}
    ...
    def get_players_to_rob(self, hexIndex):
        ...
        vertexList = hexLib.polygon_corners(self.flat, hexTile.hex)
